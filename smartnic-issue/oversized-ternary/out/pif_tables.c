...
#define PIF_TABLE_MAX_ENTRIES_1 1
...
__export __emem uint32_t pif_actiondata_table_0_ternary_match_mat[2 * PIF_TABLE_MAX_ENTRIES_0 * (PIF_TABLE_ACTIONDATA_SIZE_0 / 4)];
__export __emem uint32_t pif_actiondata_table_1_forward_mat[2 * PIF_TABLE_MAX_ENTRIES_1 * (PIF_TABLE_ACTIONDATA_SIZE_1 / 4)];
