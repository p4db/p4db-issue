...
struct pif_field_list_ipv4_checksum_list {
    union {
        struct {
            /* ipv4.srcAddr[32;0] */
            ...
            /* ipv4.totalLen[16;0] */
            unsigned int ipv4__totalLen:16;
            /* ipv4.identification[16;0] */
            unsigned int ipv4__identification:16;
            unsigned int _padding_0:3;
            /* ipv4.fragOffset[13;0] */
            unsigned int ipv4__fragOffset:13;
            /* ipv4.diffserv[8;0] */
            unsigned int ipv4__diffserv:8;
            /* ipv4.ttl[8;0] */
            ...
            /* ipv4.version[4;0] */
            unsigned int ipv4__version:4;
            /* ipv4.ihl[4;0] */
            unsigned int ipv4__ihl:4;
            /* ipv4.flags[3;0] */
            unsigned int ipv4__flags:3;
        };
        uint32_t _raw[5];
    };
};

struct pif_field_list_ipv4_checksum_list_packed {
    union {
        __packed struct {
            /* ipv4.version[4;0] */
            unsigned int ipv4__version:4;
